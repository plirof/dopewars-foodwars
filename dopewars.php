	...
	switch ( $action )
	{
		case "login":
			...
			if ( !isset($_SESSION['uid']) || !isset($_SESSION['player']) )
			{
				...
				echo "<p>language: ";
				echo "<select name=lang><option value=EN>English<option value=EN-VEGET>English Vegetable Edition<option value=NL".((stristr($_SERVER['HTTP_ACCEPT_LANGUAGE'],"nl"))?" SELECTED":"").">Dutch";
				echo "</select></p>";
