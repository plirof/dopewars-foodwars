...
define('POSQL_PATH', 'posql.pack.php');
...
$database_name = '__sample_posql_JOHN_';
...
<body>
<h1>Posql - <small>sample script</small></h1>
<hr>
<dl>
<?php
$options = array(
...
INSERT INTO bookmark_en (en_url, en_title)
    SELECT
           CASE url
                ...
                THEN 'http://en.sourceforge.jp/projects/posql/ΔΟΚΙΜΗ'
